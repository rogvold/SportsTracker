...
var TrainerGroupsPanel= createReactClass({
    ...
    getStateFromFlux: function(){
        ...
        return {
            ...
            groups: store.getTrainerGroups(this.props.trainerId),
    ...
    onGroupSelect: function(g){
        this.getFlux().actions.addTrainerToGroup(this.props.trainerId, g.id, function(){
            this.setState({
                groupsDialogVisible: false
            });
        }.bind(this));
    ...
    onRemove: function(g){
        this.getFlux().actions.detachTrainerFromGroup(this.props.trainerId, g.id);
    },
            ...
            <div style={this.componentStyle.placeholder} >
                ...
                {this.state.groupsDialogVisible == false ? null :
                    <Dialog content={this.getDialogContent()} dialogPanelStyle={{width: 500, padding: 15}}
                        onClose={this.setState.bind(this, {groupsDialogVisible: false})} level={10010} />
                }
