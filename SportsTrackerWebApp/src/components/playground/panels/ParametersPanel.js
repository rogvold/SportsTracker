...
var ParametersPanel= createReactClass({
    ...
    render: function () {
        ...
        return (
            <div style={this.componentStyle.placeholder} className={'parameters_panel'} >
                ...
                <div style={this.componentStyle.listPlaceholder} className={'ui form'} >
                    ...
                    {list.map(function(p, k){
                        ...
                        return (
                            <div style={this.componentStyle.item} className={'parameter_item'} >

                                <div style={this.componentStyle.name} className={'parameter_name'} >
                                ...
                                <div style={this.componentStyle.description} className={'parameter_description'} >
                                    {p.description}
                                </div>

                                {this.props.editable == false ? null :
                                    <div style={this.componentStyle.inputPlaceholder} className={'parameter_input_placeholder'} >
                                        <div className={'field'} >
                                            <input
                                                   value={val} placeholder={p.name} onChange={onChange} />
                                        </div>
                                    </div>
