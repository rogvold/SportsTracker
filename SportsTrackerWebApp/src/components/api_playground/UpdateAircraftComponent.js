...
var UpdateAircraftComponent = React.createClass({
    ...
    submit: function(){
        ...
        var self = this;
        ParseAPI.runCloudFunction('updateAircraft', data, function(d){
            console.log('updateAircraft: success: d = ', d);
            self.setState({
                responseData: d,
                responseError: undefined,
                loading: false,
            ...
            console.log('updateAircraft: error: err = ', err);
            self.setState({
                responseData: undefined,
                responseError: err,
                loading: false,
    ...
    render: function () {
        ...
        console.log('rendering UpdateAircraftComponent: data, responseError = ', data, responseError);
        ...
        return (
            <div style={this.componentStyle.placeholder}>
                ...
                <div className={'ui form'} >
                    ...
                    <i className={'icon caret right'} ></i> <b>id</b> (String)
                    <input value={this.state.id} onChange={this.onIdChange} placeholder={'id (Parse Id судна) - не путать с aircraftId (номер судна)'} />
                    <br/>
                    <br/>
                    ...
                    <input value={this.state.aircraftId} onChange={this.onAircraftIdChange} placeholder={'Номер судна (не путать с id !!!)'} />
                    <br/>
                    <br/>
