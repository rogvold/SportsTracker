...
var LoadUserSessionsComponent = React.createClass({
    ...
    submit: function(){
        ...
        var self = this;
        ParseAPI.runCloudFunction('loadUserSessions', data, function(d){
            console.log('loadUserSessions: success: d = ', d);
            self.setState({
                responseData: d,
                responseError: undefined,
                loading: false,
            ...
            console.log('loadUserSessions: error: err = ', err);
            self.setState({
                responseData: undefined,
                responseError: err,
                loading: false,
    ...
    render: function () {
        ...
        console.log('rendering LoadUserSessionsComponent: data, responseError = ', data, responseError);
