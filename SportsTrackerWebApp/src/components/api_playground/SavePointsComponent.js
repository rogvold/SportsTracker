...
var SavePointsComponent = React.createClass({
    ...
    getInitialState: function () {
        return {
            ...
            points: LocationHelper.generateFakePoints(),
    ...
    onStartTimestampChange: function(evt){
        this.setState({
            startTimestamp: evt.target.value
        });
    },
    ...
    submit: function(){
        ...
        var self = this;
        ParseAPI.runCloudFunction('savePoints', data, function(d){
            console.log('savePoints: success: d = ', d);
            self.setState({
                responseData: d,
                responseError: undefined,
                loading: false,
            ...
            console.log('savePoints: error: err = ', err);
            self.setState({
                responseData: undefined,
                responseError: err,
                loading: false,
    ...
    render: function () {
        ...
        console.log('rendering SavePointsComponent: data, responseError = ', data, responseError);
        ...
        return (
            <div style={this.componentStyle.placeholder}>
                ...
                <div className={'ui form'} >
                    ...
                    <i className={'icon caret right'} ></i> <b>startTimestamp</b> (Number)
                    <input value={this.state.startTimestamp} onChange={this.onStartTimestampChange} placeholder={'startTimestamp'} />
                    <br/>
                    <br/>

                    <i className={'icon caret right'} ></i> <b>points</b> (Array)
