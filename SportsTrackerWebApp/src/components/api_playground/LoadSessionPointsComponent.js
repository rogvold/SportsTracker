...
var LoadSessionPointsComponent = React.createClass({
    ...
    onSessionIdChange: function(evt){
        this.setState({
    ...
    submit: function(){
        ...
        var self = this;
        ParseAPI.runCloudFunction('loadSessionPoints', data, function(d){
            console.log('loadSessionPoints: success: d = ', d);
            self.setState({
                responseData: d,
                responseError: undefined,
                loading: false,
            ...
            console.log('loadSessionPoints: error: err = ', err);
            self.setState({
                responseData: undefined,
                responseError: err,
                loading: false,
    ...
    render: function () {
        ...
        console.log('rendering LoadSessionPointsComponent: data, responseError = ', data, responseError);
        ...
        return (
            <div style={this.componentStyle.placeholder}>
                ...
                <div style={{fontSize: 16, marginBottom: 10, textDecoration: 'underline'}} >
                    <b>loadSessionPoints</b>
                </div>

                <div className={'ui form'} >

                    <i className={'icon caret right'} ></i> <b>sessionId</b> (String)
                    <input value={this.state.sessionId} onChange={this.onSessionIdChange} placeholder={'sessionId'} />
                    <br/>
                    <br/>
