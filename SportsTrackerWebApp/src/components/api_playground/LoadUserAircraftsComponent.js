...
var LoadUserAircraftsComponent = React.createClass({
    ...
    submit: function(){
        ...
        var self = this;
        ParseAPI.runCloudFunction('loadUserAircrafts', data, function(d){
            console.log('loadUserAircrafts: success: d = ', d);
            self.setState({
                responseData: d,
                responseError: undefined,
                loading: false,
            ...
            console.log('loadUserAircrafts: error: err = ', err);
            self.setState({
                responseData: undefined,
                responseError: err,
                loading: false,
    ...
    render: function () {
        ...
        console.log('rendering LoadUserAircraftsComponent: data, responseError = ', data, responseError);
