...
var DeleteAircraftComponent = React.createClass({
    ...
    submit: function(){
        ...
        var self = this;
        ParseAPI.runCloudFunction('deleteAircraft', data, function(d){
            console.log('deleteAircraft: success: d = ', d);
            self.setState({
                responseData: d,
                responseError: undefined,
                loading: false,
            ...
            console.log('deleteAircraft: error: err = ', err);
            self.setState({
                responseData: undefined,
                responseError: err,
                loading: false,
    ...
    render: function () {
        ...
        console.log('rendering DeleteAircraftComponent: data, responseError = ', data, responseError);
        ...
        return (
            <div style={this.componentStyle.placeholder}>
                ...
                <div className={'ui form'} >
                    ...
                    <input value={this.state.id} onChange={this.onIdChange} placeholder={'aircraft id'} />
