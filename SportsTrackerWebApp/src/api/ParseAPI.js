...
var ParseAPI = {
    ...
    runCloudFunction: function(functionName, data, success, error){
        console.log('runCloudFunction occured: ', functionName, data);
    ...
    authorizePusherChannel: function(channelName, socketId, success, error){
        ParseAPI.runCloudFunction('authorizePusherChannel', {
            socketId: socketId,
